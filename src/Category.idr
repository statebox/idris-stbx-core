...
--   compose a b d f (compose b c d g h) = compose a c d (compose a b c f g) h
--
-- record VerifiedCategory obj (mor : obj -> obj -> Type) where
--   constructor MkVerifiedCategory
--   category      : Category obj mor
--   leftIdentity  : (a, b : obj) -> (f : mor a b) -> LeftIdentity  f cat
--   rightIdentity : (a, b : obj) -> (f : mor a b) -> RightIdentity f cat
--   associativity : (a, b, c, d : obj) -> (f : mor a b) -> (g : mor b c) -> (h : mor c d) -> Associativity {f} {g} {h} cat
