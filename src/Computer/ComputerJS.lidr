...
>   -- the data for building a functor to the category of closed typedefs
>   -> (iso : Iso (vertices g) (Fin k))
>   -> (v : Vect k (obj ComputerJS.cClosedTypedefsKleiliCategory))
>   -> Vect (length $ edges g) (mor' ComputerJS.cClosedTypedefsKleiliCategory)
>   -- a path in the graph
>   -> Path g initialVertex finalVertex
>   -- a value of the initial type
...
> compute' {initialVertex} {finalVertex} g iso v e path initialValue with (assembleElemM {cat=ComputerJS.cClosedTypedefsKleiliCategory}
>                                                                                        {m=Maybe}
>                                                                                        (edges g)
>                                                                                        (to iso)
>                                                                                        v
>                                                                                        (\k, l => extractMorphism {cat=ComputerJS.cClosedTypedefsKleiliCategory}
>                                                                                                                  {f=Maybe}
>                                                                                                                  v e))
...
>       gEmbedding = MkGraphEmbedding {cat=ComputerJS.cClosedTypedefsKleiliCategory} (flip Vect.index v . (to iso)) morphismsFunction
